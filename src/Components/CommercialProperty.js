...
export default function CommercialProperty() {
  return (
    <div className='section-padding bg-blue py-[50px]'>
        ...
        <h2 className="lg:text-[50px] text-[36px] font-bold">Here are our
        <br/>  <span className='font-bold  text-[40px ]lg:text-[60px] text-[#0061E0]'>Commercial Property</span></h2>

        <Button variant="primary" className='flex items-center'>View More <BsArrowUpRight size={28} className='ms-3'/></Button>
        </div>
